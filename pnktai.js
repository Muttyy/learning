...
var square_mini = document.getElementsByClassName('square_mini');

for(var i = 0; i<square_mini.length; i++){
  square_mini[i].addEventListener('mouseenter', function(){
    this.classList.add("rubberBand");
    this.addEventListener("animationend", function(){
      this.classList.remove("rubberBand");
    }, false);
...
function randomColor(name){
  document.addEventListener('DOMContentLoaded', function(){
    ...
    function randomColor(){
      ...
      //}
      let colors = ["#ff648e", "#ff393e", "#88ff00", "#b04cff"];
